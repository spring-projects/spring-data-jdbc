...
public final class JdbcValue {
	...
	private JdbcValue(Object value, JDBCType jdbcType) {

		this.value = value;
		this.jdbcType = jdbcType;
	}

	public static JdbcValue of(Object value, JDBCType jdbcType) {
	...
	public boolean equals(Object o) {
		...
		return value.equals(jdbcValue.value) &&
				jdbcType == jdbcValue.jdbcType;
	}
